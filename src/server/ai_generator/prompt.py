...
输出格式：
{
  ...
  "params": {
    // anniversary/love,baby,warm: {"title": "≤20字", "start_date": "YYYY-MM-DD", "subtitle": "≤30字有创意的文案", "background_image": "可选，预设背景ID"}
    // anniversary/holiday: {"title": "≤20字", "target_date": "YYYY-MM-DD", "subtitle": "≤30字有创意的文案", "background_image": "可选，预设背景ID"}
