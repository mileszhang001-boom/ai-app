...
输出格式（严格遵循）：
{
  ...
  "theme": "love | baby | holiday | daily | clock | realtime | player | schedule",
  "params": {
    ...
    // anniversary/holiday: {"target_date": "YYYY-MM-DD", "title": "≤8字", "background_image": "预设背景ID或null"}
    // news: {"category": "general", "categories": ["tech","automotive"], "max_items": 5}
    // alarm: {"alarm_time": "HH:MM", "label": "≤15字", "repeat": "none|weekdays|weekends|daily", "display_style": "list|dial"}  注意：alarm的template_id固定为alarm_clock，theme固定为clock
...
{"template_id":"anniversary_holiday","component_type":"anniversary","theme":"holiday","params":{"target_date":"YYYY-MM-DD","title":"≤8字","background_image":null},"needs_follow_up":[],"ai_generated":{"description":"≤20字有创意的文案"}}
